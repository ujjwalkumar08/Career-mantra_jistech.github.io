<head>
		...
		<title>Mantra for Career Guidance</title>
			...
			<div class="container">
				...
				<div class="navbar-header">
					...
					<div class="navbar-brand">
						<a class="logo" href="main.php">Career Mantra</a>
					</div>
					<!-- /Logo -->
					...
					<ul class="main-menu nav navbar-nav navbar-right">
                        ...
                        <li class="dropdown">
                            ...
                            <div class="dropdown-content">
								<a href="http://localhost/career/login.php">Career Prediction</a>
                                <a href="http://localhost/career/courses.php">Courses</a>
                                <a href="http://localhost/health/blog.php">Knowledge Network</a>
